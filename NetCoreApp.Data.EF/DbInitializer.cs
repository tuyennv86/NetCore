        ...
        public async Task Seed()
        {
            ...
            if (_context.Functions.Count() == 0)
            {
                _context.Functions.AddRange(new List<Function>()
                {
                    ...
                    new Function() {Id = "CATEGORY_TYPE", Name = "Kiểu danh mục",ParentId = null,SortOrder = 1,Status = Status.Active,URL = "/admin/categoryType/index",IconCss = "fa fa-indent"  },
                    ...
                    new Function() {Id = "PRODUCT",Name = "Sản phẩm",ParentId = null,SortOrder = 2,Status = Status.Active,URL = "/",IconCss = "fa fa-folder-open"  },
                    new Function() {Id = "PRODUCT_CATEGORY",Name = "Danh mục",ParentId = "PRODUCT",SortOrder =1,Status = Status.Active,URL = "/admin/productcategory/index",IconCss = "fa fa-laptop"  },
                    ...
                    new Function() {Id = "BILL",Name = "Hóa đơn",ParentId = "PRODUCT",SortOrder = 3,Status = Status.Active,URL = "/admin/bill/index",IconCss = "fa fa-shopping-cart"  },
                    new Function() {Id = "CONTENT",Name = "Nội dung",ParentId = null,SortOrder = 3,Status = Status.Active,URL = "/",IconCss = "fa fa-newspaper"  },
                    new Function() {Id = "BLOG",Name = "Bài viết",ParentId = "CONTENT",SortOrder = 1,Status = Status.Active,URL = "/admin/blog/index",IconCss = "fa fa-wpforms"  },
                    ...
                    new Function() {Id = "SLIDE",Name = "Slide",ParentId = "UTILITY",SortOrder = 5,Status = Status.Active,URL = "/admin/slide/index",IconCss = "fa fa-object-ungroup"  },
                    ...
                    new Function() {Id = "REVENUES",Name = "Báo cáo doanh thu",ParentId = "REPORT",SortOrder = 1,Status = Status.Active,URL = "/admin/report/revenues",IconCss = "fa bar-chart"  },
            ...
            if (_context.Colors.Count() == 0)
            {
                List<Color> listColor = new List<Color>()
                {
                    ...
                    new Color() {Name="Xanh", Code="#0000ff" },
                };
